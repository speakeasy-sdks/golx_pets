...
func main() {
    ...
    res, err := s.Pet.AddPetForm(ctx, shared.Pet{
        ...
        Tags: []shared.Tag{
            shared.Tag{
                ID: petst.Int64(778157),
                Name: petst.String("Teri Strosin"),
            },
            shared.Tag{
                ID: petst.Int64(799159),
                Name: petst.String("Erik Lebsack"),
            },
            shared.Tag{
            ...
            shared.Tag{
                ID: petst.Int64(944669),
                Name: petst.String("Everett Breitenberg"),
            },
        },
    }, operationSecurity)
    if err != nil {
...
func main() {
    ...
    res, err := s.Pet.AddPetJSON(ctx, shared.Pet{
        ...
        Tags: []shared.Tag{
            shared.Tag{
                ID: petst.Int64(216550),
                Name: petst.String("Brandon Auer"),
            },
            shared.Tag{
                ID: petst.Int64(149675),
                Name: petst.String("Curtis Morissette"),
            },
        },
    }, operationSecurity)
    if err != nil {
...
func main() {
    ...
    res, err := s.Pet.UpdatePetWithForm(ctx, operations.UpdatePetWithFormRequest{
        Name: petst.String("Lela Orn"),
        PetID: 170909,
        Status: petst.String("dolorem"),
    }, operationSecurity)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Pet.UpdatePetForm(ctx, shared.Pet{
        ...
        Tags: []shared.Tag{
            shared.Tag{
                ID: petst.Int64(363711),
                Name: petst.String("Velma Batz"),
            },
            shared.Tag{
                ID: petst.Int64(988374),
                Name: petst.String("Juan O'Hara"),
            },
            shared.Tag{
                ID: petst.Int64(161309),
                Name: petst.String("Shaun McCullough"),
            },
        },
    }, operationSecurity)
    if err != nil {
...
func main() {
    ...
    res, err := s.Pet.UpdatePetJSON(ctx, shared.Pet{
        ...
        Tags: []shared.Tag{
            shared.Tag{
                ID: petst.Int64(338007),
                Name: petst.String("Kayla O'Kon"),
            },
        },
    }, operationSecurity)
    if err != nil {
...
func main() {
    ...
    res, err := s.Pet.UploadFile(ctx, operations.UploadFileRequest{
        ...
        AdditionalMetadata: petst.String("tenetur"),
        PetID: 368725,
    }, operationSecurity)
    if err != nil {
        log.Fatal(err)
